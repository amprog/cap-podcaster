...
if( function_exists('register_field_group') ) {
    ...
    register_field_group(array (
        ...
        'fields' => array (
            ...
            array (
                'key' => 'field_588fd1111z34d',
                'label' => 'Podcast Archive Page Main Text',
                'name' => 'podcast_archive_main_text',
                'prefix' => '',
                'type' => 'wysiwyg',
                'instructions' => 'Enter content that is supposed to display as the main content for the podcast archive page.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array (
                    'width' => '',
